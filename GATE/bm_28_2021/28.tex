...
%\fi
\begin{align}
\label{L(y_t)_BM28} \frac{\partial y\brak{x,t}}{\partial t} &\system{L} sY(x,s) - y(x,0)\\
\label{L(y_x)_BM28} \frac{\partial y\brak{x,t}}{\partial x} &\system{L} \frac{dY\brak{x,s}}{dx}
\end{align}
From Laplace transforms \eqref{L(y_t)_BM28} and \eqref{L(y_x)_BM28}, we get
\begin{align}
